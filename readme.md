...
```
oc apply --context="${CTX_CLUSTER1}" -n superheroes -f ./East_Cluster/resources/Monitoring/podMonitor.yaml
```
```
oc apply --context="${CTX_CLUSTER2}" -n superheroes -f ./West_Cluster/resources/Monitoring/podMonitor.yaml
```
